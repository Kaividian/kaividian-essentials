...
module Game
  ...
  def self.set_up_system
    save_data = (SaveData.exists?(SaveData::SAVE_INDEX)) ? SaveData.read_from_file(SaveData::FILE_PATHS[SaveData::SAVE_INDEX]) : {}
    if save_data.empty?
  ...
  def self.save(save_file = SaveData::FILE_PATHS[SaveData::SAVE_INDEX], safe: false)
