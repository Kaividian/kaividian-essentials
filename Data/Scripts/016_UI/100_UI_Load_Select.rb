...
class SaveSelection
  ...
  def load_save(index, initial = false)
    ...
    if @new_game
      ...
      pbDrawTextPositions(@sprites["cartridgepanel"].bitmap, [[_INTL("Slot #{index + 1}: New Game"), 192, 86, 2, Color.new(255, 255, 255), Color.new(32, 32, 32, 255)]])
      pbDrawTextPositions(@sprites["cartridgepanel"].bitmap, [[_INTL("Slot #{index + 1}: New Game"), 192 + 384, 86, 2, Color.new(255, 255, 255), Color.new(32, 32, 32, 255)]])
